<?php
$titre = 'Modifier mon article';

include 'layout/header.php';?>

<h1 class="mt-4 mb-4 text-danger">Modifier mon article</h1>
<hr color="black">

    <form action="modification_article-handler.php" method="post">
	...
	<hr color="black">
	<button type="submit" class="btn btn-danger mb-4">Modifier l'article</button>
</form>
